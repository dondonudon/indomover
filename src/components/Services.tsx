...
import { ArrowRight, Boxes, Building2, type LucideIcon, Package, Truck } from "lucide-react";
...
export default function Services() {
	...
	const openService = openSlug ? (t.services.items.find((s) => s.slug === openSlug) ?? null) : null;
						...
						return (
							...
							>
								...
								<div className="flex flex-1 flex-col p-6">
									...
									<p className="mt-2 text-sm leading-relaxed text-ink-700">{item.desc}</p>
									<button
										type="button"
